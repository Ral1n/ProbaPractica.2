...
<template>
  <TransitionRoot appear :show="globalState.modal2Open" as="template">
    <Dialog as="div" @close="globalState.close2Modal()" class="relative z-9">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex h-[calc(100%-81px)] items-center justify-center p-4 text-center backdrop mt-[81px] z-9">
              ...
              <div class="grid grid-cols-1 justify-items-center pt-[43px] px-[64px]">
                ...
                <div>
                  <input type="text" placeholder="Email"
                    class="inputText mt-[43px] pl-[24px] bg-transparent w-[362px] ring-[3px] rounded-[9px] ring-white h-[59px]">
                </div>

                <div>
                  <input type="password" placeholder="Password"
                    class="inputText  mt-[39px] pl-[24px] bg-transparent w-[362px] ring-[3px] rounded-[9px] ring-white h-[59px]">
                </div>

                <div>
                  <input type="password" placeholder="Confirm password"
                    class="inputText mt-[44px] pl-[24px] bg-transparent w-[362px] ring-[3px] rounded-[9px] ring-white h-[59px]">
                </div>

                <button @click="globalState.logIn(); globalState.close2Modal()"
                  class="flex w-[225px] h-[50px] mt-[48px] bg-white rounded-[5px] items-center justify-center">
