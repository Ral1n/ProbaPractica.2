...
<template>
  <TransitionRoot appear :show="globalState.modalOpen" as="template">
    <Dialog as="div" @close="globalState.closeModal()" class="relative z-9">
              ...
              <div class="grid grid-cols-1 justify-items-center pt-[43px] px-[64px]">
                ...
                <div>
                  <input type="text" placeholder="Email"
                    class="inputText mt-[73px] pl-[24px] bg-transparent w-[362px] ring-[3px] rounded-[9px] ring-white h-[59px]">
                </div>

                <div>
                  <input type="password" placeholder="Password"
                    class="inputText pl-[24px] mt-[39px] bg-transparent w-[362px] ring-[3px] rounded-[9px] ring-white h-[59px]">
                </div>

                <button @click="globalState.logIn(); globalState.closeModal()"
                  class="flex w-[163px] h-[50px] mt-[111px] bg-white rounded-[5px] items-center justify-center">
